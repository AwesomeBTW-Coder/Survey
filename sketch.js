...
function setup() {
 ...
 // createSprite(submit.x, submit.y, 10, 10);
  ...
  greeting.html("<p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp;Hello! <br> The following is a survey about our school(not really),<br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; By Aggrith Srivasttava. </p>")
  greeting.position(displayWidth/2 - 200, displayHeight/2 - 250);

  question1 = createElement('h3', "Is school a safe place?");
  ...
  question2 = createElement('h3', "Are you educated?");
  ...
  question3 = createElement('h3', "Are you dumb?");
  ...
  question4 = createElement('h3', "Is our planet flat?");
